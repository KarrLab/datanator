...
class QuerySubcellularProteinLocalization(mongo_util.MongoUtil):
    ...
    def create_genotype_obj(self):
        ...
        obj_taxon_in_genotype["name"] = "homo sapien"
...
def main():
    ...
    directory = "./datanator/docs/protein_localization/subcellular_localization/subcellularJSON/subcellular_files"
    max_entries = 100
