import unittest
from datanator.data_source.rna_halflife import doi_10_1073_pnas_112318199
import tempfile
import shutil
import json
import os
...
class TestProteinAggregate(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        MongoDB = conf.SERVER    
        cls.src = doi_10_1073_pnas_112318199.Halflife(server=MongoDB, src_db=src_db,
    ...
    def test_fill_rna_halflife(self):
        self.src.fill_rna_halflife("./docs/rna_halflife/3181Table5.csv", skip=9)