...
class ProteinInteractionandComplexQuery(unittest.TestCase):
    ...
    def test_get_observed_result_subunit(self):
        ...
        self.assertEqual(set([o.interaction.specie_a.uniprot_id for o in observed_interaction if o.interaction.specie_a.__class__.__name__ == 'ProteinSpecie']),
            set(['Q05193', 'P49418', 'Q9UQ16', 'O43426']))
    ...
    def test_get_interaction_by_subunit(self):
        ...
        self.assertEqual(set([i.protein_a for i in interactions]), set(['qrplrrprm', 'hrptrskla', 'grpprnarv', 'O43426', 'Q9UQ16', 'hrpvrraap', 'Q05193', 'P49418', 'vrptraada', 'vrparrvlw']))
        self.assertEqual(set([i.protein_b for i in interactions]), set(['O43426', 'xrprrghal', 'rrprrslpe', 'P50570', 'krpprdgtl', 'tpkrppril', 'Q05193', 'P49418', 'hrpwrrwre', 'trpyrpthp']))
