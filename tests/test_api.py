...
class ApiTestCase(unittest.TestCase):
    def test(self):
        ...
        self.assertIsInstance(kinetic_datanator.api.query, types.ModuleType)
        self.assertIsInstance(kinetic_datanator.api.query.dna_protein_interactions, types.ModuleType)
