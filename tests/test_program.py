...
class TestProgram(unittest.TestCase):
	...
	def test_get_ec_number(self):
		...
		#in sub_array are swapped, the result should be an empty string
		...
		#2) cases where the reaction is 3 and 3, but simply looping through each three with sub_inchi_smiles = sub_inchi_smiles[-1:] + sub_inchi_smiles[:-1]
