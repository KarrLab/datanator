...
class TestFlaskProteintoDNAInteractionQueryGenerator(unittest.TestCase):
    """
    Tests for Protein to DNA interactions
    ...
    def test_filter_observed_values(self):
        q = dpi.FlaskProteintoDNAInteractionQueryGenerator()
...
class TestFlaskDNAtoProteinInteractionQueryGenerator(unittest.TestCase):
    """
    Tests for DNA to Protein interactions
    ...
    def test_filter_observed_values(self):
        q = dpi.FlaskDNAtoProteinInteractionQueryGenerator()
