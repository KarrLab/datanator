...
class TestProteinInteractionandComplexQueryGenerator(unittest.TestCase):
...
class TestFlaskProteinInteractionandComplexQueryGenerator(unittest.TestCase):
    ...
    def test_get_observable_complex(self):
        q= ppi.FlaskProteinInteractionandComplexQueryGenerator()
