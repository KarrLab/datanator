...
# spec_com = importlib.util.spec_from_file_location("common", './utils/common.py')
# spec_mongo = importlib.util.spec_from_file_location("mongo", './utils/mongo.py')
# module_com = importlib.util.module_from_spec(spec_com)
# module_mongo = importlib.util.module_from_spec(spec_mongo)
# spec_com.loader.exec_module(module_com) #import ask, safewfile, LogPrint, timesofar
# spec_mongo.loader.exec_module(module_mongo) #import get_src_dump
import sys
sys.path.append('./utils')
from common import ask, safewfile, LogPrint, timesofar
from mongo import get_src_dump
