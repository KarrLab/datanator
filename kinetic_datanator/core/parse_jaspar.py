...
f = urlopen('http://jaspar.genereg.net/html/DOWNLOAD/database/MATRIX_PROTEIN.txt')
...
f = urlopen('http://jaspar.genereg.net/html/DOWNLOAD/database/MATRIX_SPECIES.txt')
NCBI = reader(f, delimiter = '\t')
NCBI = make_jaspar_int(NCBI)
sortedlist = sort(NCBI)
NCBI, key_NCBI = group_by_jaspar_id(sortedlist)

f = urlopen('http://jaspar.genereg.net/html/DOWNLOAD/database/MATRIX_ANNOTATION.txt')
...
f = urlopen('http://jaspar.genereg.net/html/DOWNLOAD/database/MATRIX_DATA.txt')
...
f = urlopen('http://jaspar.genereg.net/html/DOWNLOAD/database/MATRIX.txt')
lines = f.readlines()
